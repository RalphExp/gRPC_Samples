...
func (s *server) GetOrder(ctx context.Context, orderId *wrapper.StringValue) (*pb.Order, error) {
	...
	return nil, status.Errorf(codes.NotFound, "Order does not exist. : %v", orderId)
}
