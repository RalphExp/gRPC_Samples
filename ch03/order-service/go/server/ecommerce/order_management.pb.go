...
var file_order_management_proto_rawDesc = []byte{
	...
	0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0d, 0x5a, 0x0b, 0x2e,
...
func file_order_management_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_order_management_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Order); i {
			case 0:
				return &v.state
			case 1:
		...
		file_order_management_proto_msgTypes[1].Exporter = func(v any, i int) any {
